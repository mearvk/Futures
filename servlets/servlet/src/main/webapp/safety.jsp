...
<nav>
    ...
    <a href="safety.jsp" class="active">Safety</a>
    <a href="status.jsp">Status</a>
</nav>

<section>
    <h2>Safety Ledger — Last 50 Events</h2>
<%
...
<%
        ...
        try {
            ...
            ps = conn.prepareStatement("SELECT id, event_type, connection_id, reason, timestamp FROM safety_events ORDER BY id DESC LIMIT 50");
            rs = ps.executeQuery();
%>
    <table>
        <thead><tr><th>ID</th><th>Event Type</th><th>Connection</th><th>Reason</th><th>Timestamp</th></tr></thead>
        <tbody>
<%
            while (rs.next()) {
%>
